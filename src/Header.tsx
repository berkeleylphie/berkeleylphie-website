...
// Menu items are in `navItems` below. Some pages are hidden: their buttons point to the
// 'coming' (Coming Soon) page — search for 'coming' below to re-enable them.
          ...
          <nav className="hidden lg:flex items-center gap-2">
                ...
                >
                  ...
                  {brothersDropdownOpen && (
                    <div className="absolute top-full left-0 w-56 bg-surface overflow-hidden">
                      ...
                      {/* Executive Board page is hidden for now — change 'coming' to 'executives' to turn it back on */}
                      <button
                      ...
                      {/* Alumni page is hidden for now — change 'coming' to 'alumni' to turn it back on */}
                      <button
            ...
            {isAuthenticated ? (
              <>
                ...
                // Login page is hidden for now — change 'coming' to 'login' to turn it back on
                <button
