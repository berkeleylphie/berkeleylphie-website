...
export const people: Person[] = [
  // ---- Active brothers ----
  { id: 1, name: 'Alex Siu', category: 'brother', year: 'Year', major: 'Major', hometown: 'Hometown', image: alex },
  { id: 2, name: 'Colin Suzuki', category: 'brother', year: 'Year', major: 'Major', hometown: 'Hometown', image: colin },
  { id: 3, name: 'Daniel Phan', category: 'brother', year: 'Year', major: 'Major', hometown: 'Hometown', image: daniel },
  { id: 4, name: 'David Shi', category: 'brother', year: 'Year', major: 'Major', hometown: 'Hometown', image: david },
  { id: 5, name: 'Hunter Flores', category: 'brother', year: 'Year', major: 'Major', hometown: 'Hometown', image: '' },
  { id: 6, name: 'Ingu Hwang', category: 'brother', year: 'Year', major: 'Major', hometown: 'Hometown', image: ingu },
  { id: 7, name: 'Jason Pham', category: 'brother', year: 'Year', major: 'Major', hometown: 'Hometown', image: jpham },
  { id: 8, name: 'Jason Yang', category: 'brother', year: 'Year', major: 'Major', hometown: 'Hometown', image: jyang },
  { id: 9, name: 'Jeffrey Wu', category: 'brother', year: 'Year', major: 'Major', hometown: 'Hometown', image: jeff },
  ...
  { id: 12, name: 'Shash Shrestha', category: 'brother', year: 'Year', major: 'Major', hometown: 'Hometown', image: '' },
  { id: 13, name: 'Tayler Nguyen', category: 'brother', year: 'Year', major: 'Major', hometown: 'Hometown', image: tayler },
  { id: 14, name: 'Tommy Zeng', category: 'brother', year: 'Year', major: 'Major', hometown: 'Hometown', image: tommy },
  { id: 15, name: 'Yenadi Aye', category: 'brother', year: 'Year', major: 'Major', hometown: 'Hometown', image: '' },
